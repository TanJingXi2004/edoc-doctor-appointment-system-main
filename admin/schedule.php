    ...
    <div class="container">
        ...
        <div class="dash-body">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                ...
                <?php
                    if($_POST && isset($_POST["filter"])){ // Ensure filter is set
                        //print_r($_POST);
                        $sqlpt1="";
        ...
        if($action=='add-session'){
                                ...
                                <center>
                                 ...
                                 <tbody>';
                                         ...
                                         if($result_app->num_rows==0){
                                             ...
                                             <br>
                                             <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">No patients have registered for this session yet.</p>
                                             </center>
                                             <br><br><br><br>
                                             </td>
                                             </tr>';
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="schedule.php?action=add-session&id=none&error=0" class="non-style-link"><button  class="btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">  Try Again  </font></button></a>
                        <a href="schedule.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">  OK  </font></button></a>
                        <br><br><br><br>
                        </div>
                    </center>
